            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <ul class="side-menu metismenu">
                        <li>
                            <a class="active"  href="{{route('cheques.index')}}"><i class="sidebar-item-icon fa fa-th-large"></i>
                                <span class="nav-label">Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a class="active"  href="{{route('cheques.create')}}"><i class="sidebar-item-icon fa fa-plus-square"></i>
                ...
                <div class="check-list m-b-20 m-t-10">
                    <label class="ui-checkbox ui-checkbox-gray">
                        ...
                        <label class="ui-checkbox ui-checkbox-gray">
                            ...
                            <script src="{{ asset('./assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.j') }}s" type="text/javascript"></script>
                            <!-- CORE SCRIPTS-->
